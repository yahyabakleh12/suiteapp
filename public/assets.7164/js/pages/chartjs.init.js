  ...
  ChartJs.prototype.init = function () {
    ...
    var lineChart = {
      ...
      datasets: [{
        ...
        pointBorderColor: "#984e77",
        pointBackgroundColor: "#fff",
        pointBorderWidth: 1,
        pointHoverRadius: 5,
        pointHoverBackgroundColor: "#984e77",
    ...
    var donutChart = {
      ...
      datasets: [{
        data: [300, 210],
        backgroundColor: ["#984e77", "#ebeff2"],
        hoverBackgroundColor: ["#984e77", "#ebeff2"],
    ...
    var radarChart = {
      ...
      datasets: [{
        ...
        backgroundColor: "rgba(85, 110, 230, 0.2)",
        borderColor: "#984e77",
        pointBackgroundColor: "#984e77",
        pointBorderColor: "#fff",
        pointHoverBackgroundColor: "#fff",
        pointHoverBorderColor: "#984e77",
    ...
    var polarChart = {
      datasets: [{
        data: [11, 16, 7, 18],
        backgroundColor: ["#f46a6a", "#34c38f", "#f1b44c", "#984e77"],
        label: 'My dataset',
        // for legend
        hoverBorderColor: "#fff"
      }],
