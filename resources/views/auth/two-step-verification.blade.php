                                                            ...
                                                            <div class="item">
                                                                <div class="py-3">
                                                                    <p class="font-size-16 mb-4">" Fantastic theme with a
                                                                        ...
                                                                        staff the documentation talks about. "</p>

                                                                    <div>
                                                                        <h4 class="font-size-16 text-primary">Abs1981</h4>
                                                                        <p class="font-size-14 mb-0">- Suite Life User</p>
                                                                    </div>
                                                                </div>
                                ...
                                <div class="d-flex flex-column h-100">
                                    ...
                                    <div class="my-auto">
                                        <div class="text-center">
                                            ...
                                            <div class="p-2 mt-4">
                                                ...
                                                <p class="mb-5">Please enter the 4 digit code sent to <br> <span
                                                        class="font-weight-semibold">+971 ***** {{$phone}}</span></p>

                                                <form action="{{URL('/two-factory-auth')}}" method="POST">
                                                    @csrf
                                                    <div class="row">
                                                        <div class="col-3">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text"
                                                                    ...
                                                                    maxLength="1" id="digit1" name="digit1">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-3">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text"
                                                                    class="form-control form-control-lg text-center"
                                                                    maxLength="1" id="digit2" name="digit2">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-3">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text"
                                                                    class="form-control form-control-lg text-center"
                                                                    maxLength="1" id="digit3" name="digit3">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-3">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text"
                                                                    class="form-control form-control-lg text-center"
                                                                    maxLength="1" id="digit4" name="digit4">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </form>
                                    ...
                                    <div class="mt-4 mt-md-5 text-center">
                                        <p class="mb-0">© <script>
                                            ...
                                            </script> Suite Life. Crafted with <i class="mdi mdi-heart text-danger"></i> by
                                            Themesbrand</p>
                                    </div>
                                </div>
