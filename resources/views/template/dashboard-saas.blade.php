                            ...
                            <div class="media">
                                ...
                                <div class="media-body align-self-center">
                                    <div class="text-muted">
                                        <p class="mb-2">Welcome to Suite Life Dashboard</p>
                                ...
                                <table class="table table-nowrap align-middle table-hover mb-0">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <h5 class="text-truncate font-size-14 mb-1"><a href="#"
                                                        class="text-dark">Suite Life Saas Dashboard</a></h5>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <h5 class="text-truncate font-size-14 mb-1"><a href="#"
                                                        class="text-dark">Suite Life Crypto Dashboard</a></h5>
