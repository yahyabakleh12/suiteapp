                    ...
                    <div class="col-lg-12">
                        <div class="text-center mb-5 text-muted">
                            <a href="index" class="d-block auth-logo">
                                <img src="{{ URL::asset('/assets/images/logo.png') }}" alt="" height="20" class="auth-logo-dark mx-auto">
                                <img src="{{ URL::asset('/assets/images/logo.png') }}" alt="" height="20" class="auth-logo-light mx-auto">
                            </a>
                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        ...
                        <div class="mt-5 text-center">
                            ...
                            <p>© <script>
                                ...
                                </script> Suite Life. Crafted with <i class="mdi mdi-heart text-danger"></i> by Themesbrand</p>
                        </div>
