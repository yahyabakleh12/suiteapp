                        ...
                        <div id="upcoming-task" class="pb-1 task-list">
                            ...
                            <div class="card task-box" id="uptask-3">
                                <div class="card-body">
                                    ...
                                    <div>
                                        <h5 class="font-size-15"><a href="javascript: void(0);" class="text-dark" id="task-name">Create a Suite Life Logo</a></h5>
                        ...
                        <div id="inprogress-task" class="pb-1 task-list">
                            ...
                            <div class="card task-box" id="intask-3">
                                <div class="card-body">
                                    ...
                                    <div>
                                        <h5 class="font-size-15"><a href="javascript: void(0);" class="text-dark" id="task-name">Suite Life Dashboard UI</a></h5>
                                        <p class="text-muted mb-4">13 Oct, 2019</p>
                                    </div>
                        ...
                        <div id="complete-task" class="pb-1 task-list">
                            ...
                            <div class="card task-box" id="cmptask-3">
                                <div class="card-body">
                                    ...
                                    <div>
                                        <h5 class="font-size-15"><a href="javascript: void(0);" class="text-dark" id="task-name">Suite Life landing Psd</a></h5>
                                        <p class="text-muted mb-4">15 Oct, 2019</p>
                                    </div>
