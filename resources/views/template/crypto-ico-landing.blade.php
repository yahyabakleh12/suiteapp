...
<head>
    ...
    <meta charset="utf-8" />
    <title>@lang('translation.ICO_Landing') | Suite Life - Admin Dashboard </title>
    ...
    <nav class="navbar navbar-expand-lg navigation fixed-top sticky">
        <div class="container">
            <a class="navbar-logo" href="index">
                <img src="{{ URL::asset('/assets/images/logo.png') }}" alt="" height="19" class="logo logo-dark">
                <img src="{{ URL::asset('/assets/images/logo.png') }}" alt="" height="19" class="logo logo-light">
            </a>
            ...
            <div class="row align-items-center">
                <div class="col-lg-5">
                    <div class="text-white-50">
                        <h1 class="text-white font-weight-semibold mb-3 hero-title">Suite Life - Ico Landing for a
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <p class="mb-2"><script>document.write(new Date().getFullYear())</script> © Suite Life. Design & Develop by Themesbrand</p>
