                ...
                <div class="card-body">
                    <div class="media">
                        ...
                        <div class="media-body overflow-hidden">
                            <h5 class="text-truncate font-size-15">Suite Life Dashboard UI</h5>
                        ...
                        <table class="table table-nowrap align-middle table-hover mb-0">
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <h5 class="font-size-14 mb-1"><a href="#" class="text-dark">Suite Life Landing.Zip</a>
                                        </h5>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h5 class="font-size-14 mb-1"><a href="#" class="text-dark">Suite Life Admin.Zip</a></h5>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h5 class="font-size-14 mb-1"><a href="#" class="text-dark">Suite Life Logo.Zip</a></h5>
