...
@section('title') Create Building @endsection
@section('css')
...
@section('content')
    ...
    @component('components.breadcrumb')
        @slot('li_1') Buildings @endslot
        @slot('title')create new building  @endslot
    @endcomponent
    @if($errors->any())
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="needs-validation" action="{{ route('buildings.store') }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    invalid
                                    @enderror" id="validationCustom02" placeholder="Location" name="location"
                        ...
                        <div class="row">
                            ...
                            <a href="{{ route('buildings.index')}}" class="btn" style="background-color: gray;color:white">cancel</a>
                        </div>
                    </form>
                </div>
            </div>
