        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="needs-validation" action="{{ route('promotions.store') }}" method="POST"
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control select2" name="subservice_id[]" multiple required >
                                        ...
                                        @foreach ($subservices as $subservice)
                                            <option value="{{ $subservice->id }}">{{ $subservice->services->name }} - {{ $subservice->categories->name }} - {{ $subservice->name}}
                                               </option>
                                        @endforeach
                                    </select>
