                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    @enderror"
                                        ...
                                        value="{{ old('appartment_number', $user->appartment_number) }}" required>
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-control select2" name="building_id">
                                        ...
                                        <option value="{{ $user->building->id }}">{{ $user->building->name }}</option>
                            ...
                            <div class="col-12">
                                <div class="mt-4">
                                    <div class="form-check form-checkbox-outline form-check-primary mb-3">
                                        <input name="two_step" class="form-check-input" type="checkbox" id="customCheckcolor1" @if($user->two_step == 1)checked @endif>
