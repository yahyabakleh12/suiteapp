...
{{-- {{dd($subService->time_slote_subservices)}} --}}
@section('title')
    Update subService
@endsection
@section('css')
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="needs-validation" action="{{ route('subServices.update', $subService->id) }}"
                        method="POST">
                        @csrf
                        @method('put')
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    @enderror"
                                        ...
                                        value="{{ old('price', $subService->price) }}" required>
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                @enderror"
                                        ...
                                        value="{{ old('number_of_dates', $subService->number_of_dates) }} " required>
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-control select2" name="category_id">
                                        <option value="{{ $subService->category_id }}">{{ $subService->categories->name }}
                                            - {{ $subService->services->name }}</option>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control select2" name="time_slote_id[]" multiple required>
                                        ...
                                        @foreach ($subService->time_slote_subservices as $item)
                                            <option value="{{ $item->time_slote->id }}" selected>{{ $item->time_slote->time_from }} - {{ $item->time_slote->time_to }}</option>
                                            <?php $arr[$i] = $item->time_slote->id;
                                            $i++; ?>
                                        @endforeach
                                        @foreach ($time_slote as $item)
                                            @if (!in_array($item->id, $arr))
                                                <option value="{{ $item->id }}">{{ $item->time_from }} - {{ $item->time_to }}</option>
                                            @endif
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    @enderror"
                                        ...
                                        value="{{ old('promotion_from', $subService->promotion_from) }}" required>
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                </div>
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    @enderror"
                                        ...
                                        value="{{ old('promotion_to', $subService->promotion_to) }}" required>
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                </div>
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    @enderror"
                                        ...
                                        value="{{ old('discount', $subService->discount) }}" max="100" min="0"
                                        required>
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
